...
public class RankGraphFrame extends CrawlerAbstract {
  ...
  public JavaPairRDD<String, Double> rank(String nodeFile, String edgeFile, String outFile) {
    ...
    // double oriscore = 1.0/nodeRDD.count();
    double oriscore = 0.1;
    PageRank pRank = gFrame.pageRank().resetProbability(oriscore).maxIter(20);
  ...
  public static void main(String[] args) {
    ...
    // frame.rank(path + "pageUrls.txt", path + "pageRelations.txt", path +
    // "ranktest.txt");
  }
}