...
public class Corpus {
  ...
  /**
   * Loads a corpus from a given folder and scans recursively all the documents
   * inside it, then it reorder using the file name (uses FilesUtils from
   * CommonsIO), you need to choose the source of knowledge to be used
