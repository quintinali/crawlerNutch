...
/**
 * This class represents a term mapped to a knowledge based source, could
 * contain more than one sense.
 *
...
public class Topic implements Serializable {
   ...
   *
   * @param pTopic
   *          -The String extracted by the term extraction algorithm, (the
   *          string that was found in the corpus)
   */
  ...
  /**
   *
   * @return the topic - returns a string containing the exact string with this
   *         topic was extracted from the corpus
   */
   ...
   *
   * @param label
   *          - another way of represent this topic
   */
   ...
   *
   * @param pSense
   *          - a possible sense for this term
   */
  ...
  /**
   * Add a translation to this concept, using a language code, (see wikipedia
   * for language codes)for example. 'es' = spanish
   *
   * @param language
   * @param translation
   */
  ...
  /**
   * Initializes the sense counts for disambiguation purposes given the number
   * of possible senses
   */
  ...
  public String getGoodSense() {
    // TODO: if the topic has no sense for the domain (like produced) need to
    // change this
    int aux = 0;
    int max = 0;
  ...
  /**
   * The disambiguation process failed in this topic, aka 'should be deleted'
   * this is only used by cvalueWikiminerDisambiguation method
   *
   ...
   *
   * @param disambiguationFail
   *          the disambiguationFail to set
   */
   ...
   *
   * @param pSense
   *          - the string representing the sense(should be the knoledge base
   *          title of this title)
   * @param id
   *          - the knowledge source id of this sense.
   * @param confidence
   */
  ...
  /**
   * Return a hash maps of the parent categories of this topic represented in a
   * HashMap with Source identifier,SourceTitle pairs
   *
   * @return
   */
  ...
  /**
   * Adds a id to the current added sense in the senseList The order must be the
   * same as isn't controlled
   *
   * @param pSenseId
   */
  ...
  /**
   * Returns the given id for the sense, see the SenseList for obtaining the
   * current position for the desired sense
   *
   * @param pNum
   * @return
   */
  ...
  /**
   * @param domainRelatedness
   *          the domainRelatedness to set
   */
