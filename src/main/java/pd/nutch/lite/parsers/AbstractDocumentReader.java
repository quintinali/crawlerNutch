...
/**
 * Class that represent a document reader for LiTe, all readers must extend this
 * class
 * 
...
public abstract class AbstractDocumentReader {
  ...
  protected List<String> noiseSentences;
  ...
  public AbstractDocumentReader() {
    ...
    noiseSentences = new ArrayList<String>();
    noiseSentences.add(":");    
    noiseSentences.add("."); 
    noiseSentences.add("?"); 
    noiseSentences.add("!"); 
   ...
   * linked list of tokens, each token will have the his POS tag For javadoc of
   * Token see Javadoc link of
  ...
  public abstract void readSentences(String pSource);
  ...
  /**
   * print the text and the POS tags and syntactic information if available to
   * the standard output
   */
  ...
  public void addNosieSentences(List<String> noises) {
    this.noiseSentences.addAll(noises);
  }
}
