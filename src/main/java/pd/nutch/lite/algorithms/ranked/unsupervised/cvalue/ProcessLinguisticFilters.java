...
import pd.nutch.lite.algorithms.ranked.unsupervised.cvalue.filters.ILinguisticFilter;
...
/**
 * This class take the tokenized text, and process it throught the desired
 * filters
 *
...
public class ProcessLinguisticFilters {
  ...
  /**
   * takes a tokenized text, and get a list of candidates processing all the
   * linguistic filters
   *
   * @param text
   * @return
