...
import pd.nutch.lite.utils.ixatools.pos.pos.Resources;
 ...
 * 
 */
public class MorfologikLemmatizer implements pd.nutch.lite.utils.ixatools.pos.lemma.DictionaryLemmatizer {
   ...
   */
  public MorfologikLemmatizer(final URL dictURL, final String aLang) throws IOException {
  ...
  private List<String> getDictKeys(final String word, final String postag) {
    ...
    final String constantTag = this.tagRetriever.setTagConstant(this.lang, postag);
