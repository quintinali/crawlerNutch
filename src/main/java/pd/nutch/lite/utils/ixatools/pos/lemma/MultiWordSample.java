...
public class MultiWordSample {
  ...
  public MultiWordSample(final String id, final String[] sentence, Span[] multiwords) {
  ...
  public boolean equals(final Object obj) {
    ...
    if (this == obj) {
      ...
      return Arrays.equals(getSentence(), a.getSentence()) && Arrays.equals(getNames(), a.getNames());
    } else {
      return false;
    }
  }
