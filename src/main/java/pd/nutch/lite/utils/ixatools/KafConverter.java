...
package pd.nutch.lite.utils.ixatools;

import pd.nutch.lite.model.Document;
import pd.nutch.lite.model.Token;
import pd.nutch.lite.utils.ixatools.pos.pos.Morpheme;
...
public class KafConverter {
  ...
  /**
   * Given a KAF document returns a Lite Document containing the sentence list
   * and the tokenized sentence list
   *
   * @param kaf
