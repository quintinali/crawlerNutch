...
public final class StringUtils {
   ...
   */
  public static List<Integer> exactTokenFinderIgnoreCase(final String pattern, final String[] tokens) {
   ...
   * @return token spans of the pattern (e.g. a named entity)
   */
  public static List<Integer> exactTokenFinder(final String pattern, final String[] tokens) {
    final String[] patternTokens = pattern.split(" ");
    int i, j;
    final int patternLength = patternTokens.length;
    final int sentenceLength = tokens.length;
   ...
   *         found
   */
  public static List<Integer> exactStringFinder(final String pattern, final String sentence) {
    final char[] patternArray = pattern.toCharArray(), sentenceArray = sentence.toCharArray();
    int i, j;
   ...
   */
  public static String getStringFromSpan(final Span reducedSpan, final String[] tokens) {
  ...
  public static List<File> getFilesInDir(final File inputPath) {
    ...
    for (final File aFile : Files.fileTreeTraverser().preOrderTraversal(inputPath)) {
      if (aFile.isFile()) {
        fileList.add(aFile);
      }
    }
