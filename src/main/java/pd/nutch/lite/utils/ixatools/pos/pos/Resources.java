...
public class Resources {
  ...
  public final InputStream getDictionary(final String lang) {
    ...
    if (lang.equalsIgnoreCase("en")) {
      dict = getClass().getResourceAsStream("/lemmatizer-dicts/language-tool/en-lemmatizer.txt");
    }
    if (lang.equalsIgnoreCase("es")) {
      dict = getClass().getResourceAsStream("/lemmatizer-dicts/freeling/es-lemmatizer.txt");
    }
    if (lang.equalsIgnoreCase("gl")) {
      dict = getClass().getResourceAsStream("/lemmatizer-dicts/ctag/gl-lemmatizer.txt");
    }
    return dict;
  }
  ...
  public final URL getBinaryTaggerDict(final String lang) {
    URL dictURL = null;
    if (lang.equalsIgnoreCase("es")) {
      dictURL = getClass().getResource("lemmatizer-dicts/freeling/spanish-monosemic.dict");
    }
    if (lang.equalsIgnoreCase("gl")) {
      dictURL = getClass().getResource("lemmatizer-dicts/ctag/galician-monosemic.dict");
    }
    return dictURL;
  }
