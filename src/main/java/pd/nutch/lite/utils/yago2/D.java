 ...
 * 
 * 
 * This class provides convenience methods for Input/Output. Allows to do basic
 * I/O with easy procedure calls -- nearly like in normal programming languages.
...
public class D {
  ...
  /**
   * Given a map that maps to collections, adds a new key/value pair or
   * introduces the ke
   * 
   * @param <K>
   * @param <L>
  ...
  /**
   * Given a map that maps to integers, adds a new key/value pair or increases
   * the counte
   * 
   * @param <K>
   * @param map
  ...
  /**
   * Given a map that maps to floats, adds a new key/value pair or increases the
   * counte
   * 
   * @param <K>r
   * @param map
  ...
  /**
   * Given a map that maps to doubles, adds a new key/value pair or increases
   * the counte
   * 
   * @param <K>
   * @param map
  ...
  /**
   * Given a map that maps to comparable objects, sets a key to a given value
   * iff the current value is null or smaller than the given valu
   * 
   * @param <K>
   * @param <V>
   * @param map
  ...
  /**
   * Compares pairs of comparable things (a1,a2,b1,b2,...) for equality,
   * including NULL
   * 
   * @param o
   * @return
  ...
  /**
   * Returns a reasonable String representation of a sequence of things. Handles
   * arrays, deep arrays and NULL
   * 
   * @param o.
   * @return
   */
