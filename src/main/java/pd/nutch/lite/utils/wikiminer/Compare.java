...
public class Compare implements Serializable {
   ...
   *          the disambiguationConfidence to set
   */
  ...
  public String toString() {
    ...
    return String.format("First term= %s id= %d \nSecond term= %s id= %d \nrelatedness= %f \ndisambiguationConfidence= %f", getTerm1(), getTerm1Id(), getTerm2(), getTerm2Id(), getRelatedness(),
