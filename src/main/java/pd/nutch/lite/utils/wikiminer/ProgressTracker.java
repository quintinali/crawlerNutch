...
public final class ProgressTracker {
   ...
   *
   * @param taskParts
   *          the number of parts this task involves.
   * @param message
   *          the message to be displayed alongside all progress updates
   * @param logClass
   */
  @SuppressWarnings("rawtypes")
  ...
  /**
   * Creates a ProgressTracker for tracking the given number of tasks. You will
   * have to call startTask before starting each one.
   *
   * @param tasks
   *          the task this notifier will track.
   * @param logClass
   */
  @SuppressWarnings("rawtypes")
   ...
   *
   * @param val
   *          the minimum time between display messages, in milliseconds.
   */
